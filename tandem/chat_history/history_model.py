...
class HistoryModel(QAbstractListModel):
    ...
    def add_message(self, author: str, message: str):
        self.beginInsertRows(self.currentIndex, self.rowCount(), self.rowCount())
        self.insertRow(self.rowCount(), QModelIndex())
        response_worker = self.tandem.invoke(author, message)
        self.endInsertRows()
        response_worker.response_received.connect(self.handle_response, Qt.ConnectionType.SingleShotConnection)
